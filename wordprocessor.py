...
IMAGE_EXTENSIONS = ['.jpg','.png','.bmp', '.pdf', '.docx']
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        open_file_action = QAction(QIcon(os.path.join('images', 'red-folder-open-document.png')), "Open file...", self)
        open_file_action.setStatusTip("Open file")
        open_file_action.triggered.connect(self.file_open)
        file_menu.addAction(open_file_action)
        file_toolbar.addAction(open_file_action)

        save_file_action = QAction(QIcon(os.path.join('images', 'save.png')), "Save", self)
        save_file_action.setStatusTip("Save current page")
        save_file_action.triggered.connect(self.file_save)
        file_menu.addAction(save_file_action)
        file_toolbar.addAction(save_file_action)

        saveas_file_action = QAction(QIcon(os.path.join('images', 'save--pencil.png')), "Save As...", self)
        ...
        self.alignl_action = QAction(QIcon(os.path.join('images', 'edit-alignment-left.png')), "Align left", self)
    ...
    def file_open(self):
        path, _ = QFileDialog.getOpenFileName(self, "Open file", "", "HTML documents (*.html);Text documents (*.txt);Word Document (*.docx);All files (*.*)")
    ...
    def file_saveas(self):
        path, _ = QFileDialog.getSaveFileName(self, "Save file", "", "HTML documents (*.html);Text documents (*.txt);Word Document (*.docx);All files (*.*)")
